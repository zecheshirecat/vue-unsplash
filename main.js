  ...
  install(Vue, options) {
    ...
    Vue.prototype.$unsplash = {
      getPhotos: function(page, perPage, orderBy) {
        ...
        return new Promise((resolve, reject) => {
          _get(`/photos?page=${page}&per_page=${perPage}&order_by=${orderBy}&client_id=${Vue.unsplash._accessKey}`)
            .then(json => {
              resolve(json)
            })
            .catch(e => {
      ...
      getPhoto: function(id) {
        return new Promise((resolve, reject) => {
          ...
          _get(`/photos/${id}?client_id=${Vue.unsplash._accessKey}`)
            .then(json => {
      ...
      random: function(count, orientation) {
        ...
        return new Promise((resolve, reject) => {
          ...
          _get(`/photos/random?${params}&client_id=${Vue.unsplash._accessKey}`)
            .then(json => {
              resolve(json)
            })
            .catch(e => {
      ...
      getCollection: function(id) {
        return new Promise((resolve, reject) => {
          ...
          _get(`/collections/${id}/photos?client_id=${Vue.unsplash._accessKey}`)
            .then(json => {
